...
export const metadata: Metadata = {
  title: "หวยลาวพัฒนา",
  description: "วิเคราะห์สถิติหวยลาวพัฒนา ย้อนหลัง 30 งวด — เลข 3 ตัว เลข 2 ตัว ที่น่าสนใจ",
};
...
export default function LaoPattanaPage() {
  return (
    <Suspense fallback={<Loading />}>
      <LotteryPageContent config={LOTTERY_CONFIGS["lao-pattana"]} />
    </Suspense>
  );
}
