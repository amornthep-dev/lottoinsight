...
export const metadata: Metadata = {
  title: "หวยฮานอย พิเศษ",
  description: "วิเคราะห์สถิติหวยฮานอยพิเศษ ย้อนหลัง 30 งวด — เลข 3 ตัว เลข 2 ตัว ที่น่าสนใจ",
};
...
export default function HanoiSpecialPage() {
  return (
    <Suspense fallback={<Loading />}>
      <LotteryPageContent config={LOTTERY_CONFIGS["hanoi-special"]} />
    </Suspense>
  );
}
